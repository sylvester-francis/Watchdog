...
func (e *Encryptor) Encrypt(plaintext []byte) ([]byte, error) {
	...
	// #nosec G407 — gosec sees nonce passed twice and flags it as a hardcoded
	// IV. It isn't: the first arg is the destination buffer (Seal prepends
	// the nonce to the output) and the second is the nonce itself, freshly
	// generated by crypto/rand on every call.
