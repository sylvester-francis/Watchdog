...
func (m *MockMonitorRepository) GetByUserIDWithTags(ctx context.Context, userID uuid.UUID, tags map[string]string) ([]*domain.Monitor, error) {
	if m.GetByUserIDWithTagsFn != nil {
		return m.GetByUserIDWithTagsFn(ctx, userID, tags)
	}
	return nil, nil
}
