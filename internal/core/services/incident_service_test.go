...
func newTestIncidentService(
	...
	return services.NewIncidentService(incidentRepo, monitorRepo, &mocks.MockAgentRepository{}, &mocks.MockHeartbeatRepository{}, &mocks.MockAlertChannelRepository{}, notifier, &mocks.MockNotifierFactory{}, transactor, slog.Default())
}
...
func TestNewIncidentService_NilLogger(t *testing.T) {
	...
	svc := services.NewIncidentService(incidentRepo, monitorRepo, &mocks.MockAgentRepository{}, &mocks.MockHeartbeatRepository{}, &mocks.MockAlertChannelRepository{}, &mocks.MockNotifier{}, &mocks.MockNotifierFactory{}, &mocks.MockTransactor{}, nil)
...
func TestResolveIncident_RefreshFails_LogsWarning(t *testing.T) {
	...
	svc := services.NewIncidentService(incidentRepo, monitorRepo, &mocks.MockAgentRepository{}, &mocks.MockHeartbeatRepository{}, &mocks.MockAlertChannelRepository{}, notifier, &mocks.MockNotifierFactory{}, &mocks.MockTransactor{}, logger)
